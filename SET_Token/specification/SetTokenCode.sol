...
}//stops: transfer,transferFrom, approve, incr/decr Approval
...
contract BurnableToken is StandardToken{
  ...
  event Burn(address indexed burner, uint256 value);
    ...
    */
    function burn(uint256 _value) public hasBuringPermission{
...
contract DividendPayingToken is PausableToken , BurnableToken, MintableToken{
    ...
    event payedDividendEther(address reciever, uint256 amount);
    event payedDividendFromReserve(address reciever, uint256 amount);
    ...
    modifier isEligible(address _reciever){
        balanceOf(_reciever) >= EligibilityThreshold;
        _;
    }
